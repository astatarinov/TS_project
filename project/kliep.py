...
def train_kliep(data_val, sigma, z, min_diff, window_size, change_points_val, verbose=False):
    ...
    while new_st_kliep >= 0:
        ...
        new_S_kliep, new_st_kliep = compute_test_stat_kliep(data_val[st_kliep + 1:],\
                                                            window_size=window_size, sigma=sigma, threshold=z)
    ...
    while current_change_point_ind < len(change_points_val):
        ...
        current_change_point_ind += 1
    print('KLIEP, threshold =', z, '. sigma =', sigma, '. Number of false alarms:', false_alarms_kliep,\
